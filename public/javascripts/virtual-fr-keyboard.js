...
+'<div class="keys_poser french-keys" style="display: none;">'
+'<div class="drag-controls"><span>'
+'	<a href="javascript:;" title="Свернуть" class="keys_minimize">&nbsp;_&nbsp;</a> '
+'	<a href="javascript:;" title="Закрыть" class="keys_close">&nbsp;X&nbsp;</a>&nbsp;&nbsp;</span> '
+'</div>'
+'<div class="drag-panel">Виртуальная клавиатура</div>'
...
+'<tr>'
+'<td class="k_81"><div>à</div></td>'
+'<td class="k_87"><div>â</div></td>'
+'<td class="k_69"><div>ä</div></td>'
+'<td class="k_68"><div>ÿ</div></td>'
+'<td class="k_82"><div>ë</div></td>'
+'<td class="k_84"><div>ê</div></td>'
+'<td class="k_89"><div>è</div></td>'
+'<td class="k_85"><div>é</div></td>'
+'</tr>'
+'</table>'
+'<table class="virtual_keyboard" border="0" cellpadding="0" cellspacing="0" align="center">'
+'<tr>'
+'<td class="k_caps_lock"><div title="Caps Lock">⇑</div></td>'
+'<td class="k_192"><div>û</div></td>'
+'<td class="k_65"><div>ù</div></td>'
+'<td class="k_83"><div>ü</div></td>'
+'<td class="k_70"><div>œ</div></td>'
+'<td class="k_71"><div>ï</div></td>'
+'<td class="k_72"><div>î</div></td>'
+'<td class="k_74"><div>ô</div></td>'
+'<td class="k_90"><div>ç</div></td>'
+'</tr>'
+'</table>'
...
$(".virtual_keyboard td").mousedown(function() {
	...
	if ( $(".active_input").length == 0 ) {
		alert("Необходимо выбрать поле ввода!");
		return false;
	}
...
function insertFromKeyboard(string) {
	...
	activeInput.val( $.trim(beforStr + string + afterStr)  );
