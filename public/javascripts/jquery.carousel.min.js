...
this.play = function() {
	...
	tObj.playBtn.html('<img src="/images/icons/control_pause_blue.png"/>')
}

this.pause = function() {
	clearInterval(playS);
	tObj.playBtn.html('<img src="/images/icons/control_play_blue.png"/>')
}
...
this.passage = function(current, next) {
	...
	current.animate({opacity: 0, left: -600, top: -80},900,function() {
